...
export default function EmailCustomerSupportAgentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    data.source = "lead_magnet_email_customer_support_agent";
    ...
    try {
      ...
      if (res.success) {
        ...
        router.push("/email-customer-support-agent/thank-you");
      } else {
        ...
        <Column maxWidth="m" fillWidth gap="48" horizontal="center" style={{ textAlign: "center" }}>
          <Column gap="24" horizontal="center">
            <Heading variant="display-strong-m" style={{ color: "var(--bone)" }}>
              Never Lose a Lead to a Slow Reply Again
            </Heading>
            <Text variant="body-default-l" style={{ color: "var(--slate)", maxWidth: "600px" }}>
              The AI Customer Support Agent that reads your emails, qualifies your leads, and replies automatically, within minutes.
            </Text>
          </Column>
