...
export default function AutomateServiceM8ReviewsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    data.source = "lead_magnet_automate_servicem8_reviews";
    ...
    try {
      ...
      if (res.success) {
        ...
        router.push("/automate-servicem8-reviews/thank-you");
      } else {
        ...
        <Column maxWidth="m" fillWidth gap="48" horizontal="center" style={{ textAlign: "center" }}>
          <Column gap="24" horizontal="center">
            <Heading variant="display-strong-m" style={{ color: "var(--bone)" }}>
              Automate Your ServiceM8 Reviews
            </Heading>
            <Text variant="body-default-l" style={{ color: "var(--slate)", maxWidth: "600px" }}>
              Sign up below to get the free guide on how to automatically capture reviews from every completed job on ServiceM8.
            </Text>
          </Column>
