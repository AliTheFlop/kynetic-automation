        ...
        >
          ...
          <Column gap="16" horizontal="center">
            <h1 style={{
              ...
              Inquiry <span style={{ color: "var(--teal)" }}>Received.</span>
            </h1>
            <p style={{
              ...
              Thanks for reaching out! We've successfully received your details and will be in touch within 24-48 hours.
            </p>
          </Column>
